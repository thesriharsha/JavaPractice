...
//	}
	...
	// To get flights from a City
	@GetMapping("/fromflights")
	public List<Flight> getfromflights(@RequestParam() String fcity)
	{
		return flightRepo.findByFromCity(fcity);
	}
	@GetMapping("/toflights")
	public List<Flight> gettoflights(@RequestParam() String tcity)
	{
		return flightRepo.findByToCity(tcity);
	}
	
	//CANCELLED FLIGHTS
	@GetMapping("/cancelledflights")
	public List<FlightHistory> cancelledflights(@RequestParam() String remarks)
	{
		return flightHistoryRepo.findByRemarks(remarks);
	}
